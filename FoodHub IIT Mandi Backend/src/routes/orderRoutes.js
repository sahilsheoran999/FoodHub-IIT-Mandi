...
const { createNewOrder, getAllOrdersByUser, getOrder, cancelOrder, changeOrderStatus, getAllOrdersAdmin } = require('../controllers/orderController.js');

const orderRouter = express.Router();
orderRouter.post('/', isLoggedIn, createNewOrder);
orderRouter.get('/', isLoggedIn, getAllOrdersByUser);
orderRouter.get('/admin/all', isLoggedIn, isAdmin, getAllOrdersAdmin);
